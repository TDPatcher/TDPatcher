...
for e in multi_todo2method:
    ...
    for url, method, filename in zip(url_lst, method_lst, file_lst):
        ...
        if not os.path.exists('./single_todo_files/' + tgt_dir):
        ...
        with open('./single_todo_files/' + tgt_dir + '/' + filename, 'w') as fout:
